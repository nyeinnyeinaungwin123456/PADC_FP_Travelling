...
//        public static final String COLUMN_ID = "id";
    ...
    public static final class HotelEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME = "hotel-name";
        public static final String COLUMN_DESC = "description";
        public static final String COLUMN_DIRECTION = "direction-to-hotel";
        ...
        public static Uri buildHotelUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attractions?title="Yangon"
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_ID, hotelId)
                    .build();
        }
    ...
    public static final class HotelPhotosEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "hotels_photos";

        public static final String COLUMN_HOTEL_ID = "hotel-id";
        ...
        public static Uri buildHotelPhotosUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_HOTEL_ID, hotelId)
                    .build();
        }

        public static String getHotelIdFromParam(Uri uri) {
            return uri.getQueryParameter(COLUMN_HOTEL_ID);
        }
    }
    ...
    public static final class HotelPhoneEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "hotels_phone";
        ...
        public static Uri buildHotelPhoneUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_HOTEL_ID, hotelId)
                    .build();
    ...
    public static final class HighwayBusEntry implements BaseColumns {
        ...
        public static final String COLUMN_ID = "company-id";
        public static final String COLUMN_NAME = "name";
        public static final String COLUMN_DESC = "description";
        public static final String COLUMN_TICKETOUTLET = "ticketing-outlets";
    ...
    public static final class HighwayPhotoEntry implements BaseColumns {
        ...
        public static final String COLUMN_HIGHWAY_ID = "company-id";
        public static final String COLUMN_PHOTOS = "photos";
        ...
        public static Uri buildHighwayPhotoUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_HIGHWAY_ID, hotelId)
                    .build();
        }

        public static String getHighwayIdFromParam(Uri uri) {
            return uri.getQueryParameter(COLUMN_HIGHWAY_ID);
        }
    }
    ...
    public static final class HighwayPhoneEntry implements BaseColumns {
        ...
        public static final String COLUMN_HIGHWAY_ID = "company-id";
        public static final String COLUMN_PHONE = "phone-numbers";
        ...
        public static Uri buildHighwayPhoneUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_HIGHWAY_ID, hotelId)
                    .build();
    ...
    public static final class RestaurantEntry implements BaseColumns {
        ...
        public static final String COLUMN_ID = "restaurant-id";
        public static final String COLUMN_NAME = "name";
        public static final String COLUMN_DESC = "description";
        public static final String COLUMN_NOTE = "note-to-visitor";
        public static final String COLUMN_LOCATION = "location";
        public static final String COLUMN_OPTIME = "operating-time";
        ...
        public static Uri buildRestaurantUriWithId(String restaurantId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attractions?title="Yangon"
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_ID, restaurantId)
                    .build();
        }
    ...
    public static final class RestaurantPhotoEntry implements BaseColumns {
        ...
        public static final String COLUMN_RESTAURANT_ID = "restaurant-id";
        public static final String COLUMN_PHOTOS = "photos";
        ...
        public static Uri buildRestaurantPhotoUriWithId(String restaurantId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
    ...
    public static final class RestaurantOffdayEntry implements BaseColumns {
        ...
        public static final String COLUMN_RESTAURANT_ID = "restaurant-id";
        public static final String COLUMN_OFFDAY = "phone-numbers";
    ...
    public static final class TourpackageEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "tourpackage";

        public static final String COLUMN_ID = "package-id";
        public static final String COLUMN_NAME = "package-name";
        public static final String COLUMN_DESC = "description";
        public static final String COLUMN_TOTALDAY = "total-days";
        public static final String COLUMN_SUBDESTINATION = "sub-destinations";
        public static final String COLUMN_TOURCOMPANY = "tour-company";
        ...
        public static Uri buildTourpackageUriWithId(String tourpackageId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attractions?title="Yangon"
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_ID, tourpackageId)
                    .build();
        }
    ...
    public static final class TourpackagePhotoEntry implements BaseColumns {
        ...
        public static final String COLUMN_TOURPACKAGE_ID = "tourpackage-id";
        public static final String COLUMN_PHOTOS = "photos";
    ...
    public static final class TourpackageDestinationPhotoEntry implements BaseColumns {
        ...
        public static Uri buildDestinationPhotoUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_TOURPACKAGE_ID, hotelId)
                    .build();
        }

        public static String getDestinationIdFromParam(Uri uri) {
            return uri.getQueryParameter(COLUMN_TOURPACKAGE_ID);
        }
    }
    ...
    public static final class TourpackageAttractionPlacePhotoEntry implements BaseColumns {
        ...
        public static Uri buildAttractionPlacesPhotoUriWithId(String hotelId) {
            //content://xyz.aungpyaephyo.padc.myanmarattractions/attraction_images?attraction_title=Yangon
            return CONTENT_URI.buildUpon()
                    .appendQueryParameter(COLUMN_TOURPACKAGE_ID, hotelId)
                    .build();
