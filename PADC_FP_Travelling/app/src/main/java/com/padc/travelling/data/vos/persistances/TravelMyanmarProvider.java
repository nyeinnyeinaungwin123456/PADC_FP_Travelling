...
public class TravelMyanmarProvider extends ContentProvider {
    ...
    private static final String sHotelIdSelection = TravelMyanmarContract.HotelEntry.COLUMN_ID + " = ?";
    private static final String sHotelPhotoSelectionWithId = TravelMyanmarContract.HotelPhotosEntry.COLUMN_HOTEL_ID + " = ?";
    private static final String sHotelPhoneSelectionWithId = TravelMyanmarContract.HotelPhoneEntry.COLUMN_HOTEL_ID + " = ?";
    ...
    private static final String sTourpackageIdSelection = TravelMyanmarContract.TourpackageEntry.COLUMN_ID + " = ?";
    private static final String sTourpackagePhotoSelectionWithId = TravelMyanmarContract.TourpackagePhotoEntry.COLUMN_TOURPACKAGE_ID + " = ?";
    private static final String sDestinationPhotoSelectionWithId = TravelMyanmarContract.TourpackagePhotoEntry.COLUMN_TOURPACKAGE_ID + " = ?";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matchUri) {
            ...
            //HOTEL
            case HOTEL:
                String hotelId = TravelMyanmarContract.HotelEntry.getIdFromParam(uri);
            ...
            case HOTEL_PHONE:
                String hotelphoneId = TravelMyanmarContract.HotelPhoneEntry.getHotelIdFromParam(uri);
            ...
            //TOURPACKAGE
            case TOURPACKAGE:
                String tourpackageId = TravelMyanmarContract.TourpackageEntry.getIdFromParam(uri);
                if (!TextUtils.isEmpty(tourpackageId)) {
                    selection = sTourpackageIdSelection;
                    selectionArgs = new String[]{tourpackageId};
                }
            ...
            case TOURPACKAGE_PHOTO:
                String tourpackagephotoId = TravelMyanmarContract.TourpackagePhotoEntry.getTourpackageIdFromParam(uri);
                if (tourpackagephotoId != null) {
                    selection = sTourpackagePhotoSelectionWithId;
                    selectionArgs = new String[]{tourpackagephotoId};
                }
            ...
            case TOURPACKAGE_DESTINATIONPHOTO:
                String destinationphotoId = TravelMyanmarContract.TourpackageDestinationPhotoEntry.getDestinationIdFromParam(uri);
